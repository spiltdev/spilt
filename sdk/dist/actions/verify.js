 ...
 */
export function evidenceHashToBytes32(evidenceHash) {
 ...
 */
export async function submitVerifiedCompletion(walletClient, addrs, taskTypeId, sink, evidenceHash, sinkSignature) {
 ...
 */
export async function submitVerifiedExecution(walletClient, addrs, agentId, skillTypeId, evidenceHash, agentOperator, agentSig, requesterSig) {
 ...
 */
export async function reportVerifiedOutcome(walletClient, addrs, operator, skillTypeId, passed) {
 ...
 */
export async function anchorMerkleRoot(walletClient, addrs, merkleRoot) {
    return write(walletClient, {
 ...
 */
export async function isAnchored(publicClient, addrs, merkleRoot) {
