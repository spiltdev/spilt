...
[Verifiable Rewards](https://vr.dev) verifies that agent outputs actually changed system state. Harder than it sounds. Most "verification" in agent systems is soft scoring. Verifiable Rewards does hard evidence.
