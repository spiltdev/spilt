...
Backproto is deployed and verified on Base Sepolia today. Twenty-two contracts across five domains (AI agents, Nostr relays, Lightning routing, demurrage, and economy composition), 213 passing tests, a TypeScript SDK, and a research paper with formal proofs. MIT licensed.
