...
import { generateAgentSeedState, type AgentInfo } from "@/lib/shared/seed";
...
function hasData(data: ExplorerState) {
  return data.agents && data.agents.length > 0;
}

export default function AgentsPage() {
  const { state, loading } = usePolledState<ExplorerState>(
    "/api/agents/state",
    hasData,
