...
Every request that enters the Pura protocol goes through five standard objects. Each one has a JSON Schema in the SDK (`sdk/schemas/`) and a TypeScript type in `@pura/sdk`.
...
```typescript
import type { JobIntent } from "@pura/sdk";
```
...
```typescript
import type { CapacityAttestationWithMetrics } from "@pura/sdk";
```
...
```typescript
import type { VerificationReceipt } from "@pura/sdk";
```
...
```typescript
import type { PriceSignal } from "@pura/sdk";
```
...
```typescript
import type { SettlementReceipt, SettlementRail } from "@pura/sdk";
```
...
```typescript
import jobSchema from "@pura/sdk/schemas/job-intent.json";
import capacitySchema from "@pura/sdk/schemas/capacity-attestation.json";
import verificationSchema from "@pura/sdk/schemas/verification-receipt.json";
import priceSchema from "@pura/sdk/schemas/price-signal.json";
import settlementSchema from "@pura/sdk/schemas/settlement-receipt.json";
```
