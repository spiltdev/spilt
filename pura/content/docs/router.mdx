...
- **@puraxyz/sdk**: uses the full SDK for staking, pool management, pricing, and completions
- SDK is currently synced via `npm run sync-sdk` (copies local build into node_modules) until the SDK is published on npm

## Source

[github.com/puraxyz/puraxyz/tree/main/router](https://github.com/puraxyz/puraxyz/tree/main/router)
