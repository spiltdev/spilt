...
title: "Shadow mode"
order: 15
description: Install the @pura/shadow sidecar to measure what BPE would do for your service — before committing to on-chain registration.
---
...
```typescript
import { createShadow, startServer } from "@pura/shadow";
...
```typescript
import { registerSink } from "@pura/sdk/actions/capacity";
